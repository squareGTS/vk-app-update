...
//  VKApp
//
//  Created by Maxim Bekmetov on 17.08.2021.
//
...
final class LikeControl: UIControl {
    ...
    private func setView() {
        ...
        let blueHeart = UIImage(systemName: "heart", withConfiguration: largeConfig)?.withTintColor(#colorLiteral(red: 0.01734360866, green: 0.4780374765, blue: 1, alpha: 0.6994547772), renderingMode: .alwaysOriginal)
