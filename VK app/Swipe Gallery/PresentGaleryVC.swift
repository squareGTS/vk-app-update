...
class PresentGaleryVC: UIViewController {
    var photos = [Photo]()
    var selectedPhoto = 0
    ...
    func setImage(){
        ...
        leftImageView.image = photos[indexPhotoLeft].photos
        middleImageView.image = photos[indexPhotoMid].photos
        rightImageView.image = photos[indexPhotoRight].photos
